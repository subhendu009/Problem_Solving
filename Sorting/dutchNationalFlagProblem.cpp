...
void sortColors(std::vector<int>& nums)
{
    ...
    while(midIndex <= highIndex)
    {
        switch(nums[midIndex])
        {
            case 0:
            {
                // swap elements at lowIndex and MidIndex. Not using std::swap() function for optimization.
                int tempValue = nums[lowIndex];
                nums[lowIndex] = nums[midIndex];
                nums[midIndex] = tempValue;
            ...
            case 2:
            {
                // swap elements at highIndex and MidIndex. Not using std::swap() function for optimization.
                int tempValue = nums[highIndex];
